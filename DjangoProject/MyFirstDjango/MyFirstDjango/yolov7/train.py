...
if __name__ == '__main__':
    ...
    parser.add_argument('--data', type=str, default='data/ai.yaml', help='data.yaml path') 
    parser.add_argument('--hyp', type=str, default='data/hyp.scratch.p5.yaml', help='hyperparameters path')
    parser.add_argument('--epochs', type=int, default=15) #epoch
    parser.add_argument('--batch-size', type=int, default=8, help='total batch size for all GPUs') #batch size
